            ...
            <div className="p-6 md:p-8 space-y-5 md:space-y-6 flex flex-col overflow-y-auto pt-safe pb-safe">
              ...
              <div className="text-center">
                ...
                <div className="mt-4 flex justify-center gap-2">
                  <div
                    className={`h-1.5 w-12 rounded-full transition-all ${currentStep >= 1 ? "bg-white" : "bg-white/30"}`}
                  ></div>
                  <div
                    className={`h-1.5 w-12 rounded-full transition-all ${currentStep >= 2 ? "bg-white" : "bg-white/30"}`}
                  ></div>
                  <div
                    className={`h-1.5 w-12 rounded-full transition-all ${currentStep >= 3 ? "bg-white" : "bg-white/30"}`}
                  ></div>
                </div>
              </div>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        options={[
                          ...
                          {value: "deliverer", label: "Local Distributor"},
                        ]}
                        leftIcon={
