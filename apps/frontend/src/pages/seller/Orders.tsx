                ...
                <div className="p-6">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                    ...
                    <div className="flex flex-col md:items-end gap-2">
                      <p className="font-bold text-2xl text-[#98b964]">₱{order.totalAmount}</p>
                      <span
                  ...
                  <div className="border-t border-gray-100 pt-6">
                    ...
                    <div className="space-y-3">
                      <select
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#98b964] focus:border-transparent transition-all font-medium"
                        value={order.status}
                        onChange={(e) =>
