          ...
          <div className="p-4 sm:p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-5">
                Manage assigned shipments and hand off orders to local deliverers efficiently.
              </p>
              <div className="grid grid-cols-2 gap-3 mb-5">
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-3">
                  <p className="text-xs text-gray-500">Role</p>
                  <p className="text-sm font-semibold text-gray-900">Shipping Courier</p>
                </div>
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-3">
                  <p className="text-xs text-gray-500">Focus</p>
                  <p className="text-sm font-semibold text-gray-900">Order Handoff</p>
                </div>
              </div>
              <Link
                to="/courier/orders"
